...
2. Install macOS Command Line Tools by running
...
Alle the detailed documentation out in the internet, especially: 
- [Dries Vints](https://github.com/driesvints/dotfiles)

- [Github does dotfiles](https://dotfiles.github.io/)
- [Freek Murze](https://github.com/freekmurze/dotfiles)
